...
function trueOrFalse(data){
  let ans = Boolean(data) ? true : false;
  return ans
}
...
let firstFunctionScope = ['global', 'outer'];//, 'inner', 'functional']
...
let secondFunctionScope = ['global', 'functional'];//'inner', 'outer', 
...
function carFactory(mk,mdl,yr){
  ...
  ob.isNew = ob.year > 2018 ? true : false;
  return ob
}
